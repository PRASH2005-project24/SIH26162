...
def test_config_india_wide():
    ...
    try:
        ...
        print("✅ Configuration test passed: India-wide defaults confirmed")
        return True
...
def test_api_imports():
    ...
    try:
        ...
        print("✅ API imports test passed: All modules imported successfully")
        return True
    except Exception as e:
        print("❌ API imports test failed: {}".format(e))
        return False
...
def test_ml_predict_structure():
    ...
    try:
        ...
        print("✅ ML Predict structure test passed")
        return True
    except Exception as e:
        print("❌ ML Predict structure test failed: {}".format(e))
        return False
