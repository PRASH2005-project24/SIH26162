...
# Paths
input_path = r"C:\ProjectX\SIH26162\docs\FireGuard_WEAKLABELS_FIXED.csv"
output_path = r"C:\ProjectX\SIH26162\docs\stage2d\stage2d_prepared_dataset_fixed.csv"
report_path = r"C:\ProjectX\SIH26162\docs\STAGE_2D_1_DATASET_PREPARATION_FIXED.md"
...
with open(report_path, 'w') as report_file:
    report_file.write("# STAGE 2D.1 — DATASET PREPARATION & VALIDATION REPORT (FIXED LABELS)\n\n")
    ...
    report_file.write("- Use the prepared dataset (`stage2d_prepared_dataset_fixed.csv`).\n")
